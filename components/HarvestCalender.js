    ...
    <div className="w-full lg:w-1/3 p-3">
      ...
      <div className="flex items-center my-2">
        <input type="search"
               ...
               className="px-4 py-2 rounded-lg grow border placeholder:text-sm"
               onChange={(e => setSearchTerm(e.target.value))}
        />
      </div>
      <div className="grid grid-cols-7 gap-1 my-3 text-xs lg:text-base">
        <div className="col-span-2">
          <p className="flex items-center font-semibold">Origin</p>
        </div>
        ...
        <p className="flex items-center font-semibold text-right">Country</p>
      </div>
